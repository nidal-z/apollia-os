...
INSERT INTO episodic_memories (id, namespace, task_id, agent_id, content, importance, created_at, expires_at, metadata) VALUES
  ('ep-user-01', '__user__', NULL, 'apollia-guide', 'User confirmed the onboarding profile during setup.', 0.7, '2026-07-01T00:00:00Z', NULL, '{}'),
  ('ep-user-02', '__user__', NULL, 'apollia-guide', 'User asked to keep answers short.',                   0.6, '2026-07-01T00:00:00Z', NULL, '{}');
INSERT INTO procedural_memories (id, namespace, trigger_text, steps, success_count, last_used_at, created_at) VALUES
  ('proc-user-01', '__user__', 'when the user greets', '["detect language","respond in fr","offer help"]', 4, '2026-07-01T00:00:00Z', '2026-07-01T00:00:00Z');
...
INSERT INTO episodic_memories (id, namespace, task_id, agent_id, content, importance, created_at, expires_at, metadata) VALUES
  ('ep-guide-01', 'apollia-guide', NULL, 'apollia-guide', 'Explained the namespace explorer to the user.', 0.6, '2026-07-01T00:00:00Z', NULL, '{}'),
  ('ep-guide-02', 'apollia-guide', NULL, 'apollia-guide', 'Guided the user through a model download.',      0.5, '2026-07-01T00:00:00Z', NULL, '{}');
INSERT INTO procedural_memories (id, namespace, trigger_text, steps, success_count, last_used_at, created_at) VALUES
  ('proc-guide-01', 'apollia-guide', 'when asked about a feature', '["locate feature","summarize purpose","link to the page"]', 7, '2026-07-01T00:00:00Z', '2026-07-01T00:00:00Z');
...
INSERT INTO episodic_memories (id, namespace, task_id, agent_id, content, importance, created_at, expires_at, metadata) VALUES
  ('ep-onb-01', 'onboarding-agent', NULL, 'onboarding-agent', 'Collected the user profile basics.', 0.5, '2026-07-01T00:00:00Z', NULL, '{}');
INSERT INTO procedural_memories (id, namespace, trigger_text, steps, success_count, last_used_at, created_at) VALUES
  ('proc-onb-01', 'onboarding-agent', 'on first launch', '["welcome","collect profile","suggest a first agent"]', 3, '2026-07-01T00:00:00Z', '2026-07-01T00:00:00Z');
...
INSERT INTO episodic_memories (id, namespace, task_id, agent_id, content, importance, created_at, expires_at, metadata) VALUES
  ('ep-proj-01', 'seed-project-alpha:default', 'task-alpha-1', 'apollia-guide', 'Drafted the project brief for Seed Project Alpha.', 0.7, '2026-07-01T00:00:00Z', NULL, '{}'),
  ('ep-proj-02', 'seed-project-alpha:default', 'task-alpha-2', 'apollia-guide', 'Reviewed the provider configuration.',              0.6, '2026-07-01T00:00:00Z', NULL, '{}');
INSERT INTO procedural_memories (id, namespace, trigger_text, steps, success_count, last_used_at, created_at) VALUES
  ('proc-proj-01', 'seed-project-alpha:default', 'on a new document', '["index the document","extract entities","update the summary"]', 5, '2026-07-01T00:00:00Z', '2026-07-01T00:00:00Z');

-- ============================================================================
-- NAMESPACE: legacy-notes        (category: other, no ":" and not an agent)
-- ============================================================================
INSERT INTO semantic_memories (id, namespace, key, value, source, confidence, created_at, updated_at, expires_at) VALUES
  ('sem-legacy-01', 'legacy-notes', 'migration.note', '"Imported from the previous notes system"', NULL, 0.6, '2026-07-01T00:00:00Z', '2026-07-01T00:00:00Z', NULL);
INSERT INTO episodic_memories (id, namespace, task_id, agent_id, content, importance, created_at, expires_at, metadata) VALUES
  ('ep-legacy-01', 'legacy-notes', NULL, 'legacy-import', 'Legacy note archived without an owning agent.', 0.4, '2026-07-01T00:00:00Z', NULL, '{}');
INSERT INTO procedural_memories (id, namespace, trigger_text, steps, success_count, last_used_at, created_at) VALUES
  ('proc-legacy-01', 'legacy-notes', 'on archive', '["compress","store","log"]', 2, '2026-07-01T00:00:00Z', '2026-07-01T00:00:00Z');
...
INSERT INTO memory_fts (content, source_table, source_id) VALUES
  ('User confirmed the onboarding profile during setup.', 'episodic', 'ep-user-01'),
  ('User asked to keep answers short.',                   'episodic', 'ep-user-02'),
  ('Explained the namespace explorer to the user.',       'episodic', 'ep-guide-01'),
  ('Guided the user through a model download.',            'episodic', 'ep-guide-02'),
  ('Collected the user profile basics.',                  'episodic', 'ep-onb-01'),
  ('Drafted the project brief for Seed Project Alpha.',   'episodic', 'ep-proj-01'),
  ('Reviewed the provider configuration.',                'episodic', 'ep-proj-02'),
  ('Legacy note archived without an owning agent.',       'episodic', 'ep-legacy-01');
INSERT INTO memory_fts (content, source_table, source_id) VALUES
  ...
  ('migration.note "Imported from the previous notes system"',    'semantic', 'sem-legacy-01');
