...
MODULE_SIZE_FILES: set[str] = {
    ...
    "crates/apollia-cli/src/client.rs",
    "crates/apollia-cli/src/commands/audit.rs",
    "crates/apollia-cli/src/commands/chat.rs",
    "crates/apollia-cli/src/commands/chat_stream.rs",
    ...
    "crates/apollia-desktop/src/commands/config.rs",
    ...
    "crates/apollia-runtime/src/a2a/invoker.rs",
    "crates/apollia-runtime/src/api/routes_chat.rs",
    "crates/apollia-runtime/src/api/routes_llm.rs",
    "crates/apollia-runtime/src/api/routes_notifications.rs",
    "crates/apollia-runtime/src/api/routes_triggers.rs",
    "crates/apollia-runtime/src/api/server.rs",
    "crates/apollia-runtime/src/chat/builtin_agent/react_loop.rs",
    "crates/apollia-runtime/src/chat/manager/exchange.rs",
...
ARC_MUTEX_COUNTS: dict[str, int] = {
    ...
    "crates/apollia-runtime/src/chat/types.rs": 3,
...
ERROR_ENUM_COUNTS: dict[str, int] = {
    ...
    "crates/apollia-desktop/src/commands/onboarding.rs": 1,
    "crates/apollia-desktop/src/commands/ssrf.rs": 2,
    ...
    "crates/apollia-tools/src/ssrf.rs": 2,
