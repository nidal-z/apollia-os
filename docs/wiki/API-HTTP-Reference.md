...
- **TCP** `http://localhost:7771` — bearer token obligatoire depuis Sprint 34 (`Authorization: Bearer <token>`, voir [API-HTTP-Agents](./API-HTTP-Agents#authentification-tcp-sprint-34)).
