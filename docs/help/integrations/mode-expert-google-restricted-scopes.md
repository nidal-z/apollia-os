...
## Étape 1 — Créer une app OAuth Google Cloud
...
## Étape 2 — Configurer la déclaration CASA "single user"
...
## Étape 3 — Brancher l'app à Apollia
...
Redémarrez Apollia Desktop. Lors de la prochaine connexion Google, l'écran de consentement affichera votre app (`apollia-personal`) au lieu de l'app Apollia officielle, et proposera les scopes restricted ajoutés.

## Étape 4 — Activer les outils restricted dans les agents
