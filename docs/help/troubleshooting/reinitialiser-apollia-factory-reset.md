...
> **Concept :** [Securite-Donnees-Locales](https://github.com/Apollia-OS/apollia-os/wiki/Securite-Donnees-Locales) - comprendre où Apollia stocke vos données et ce qui est effacé exactement lors d'une réinitialisation.
