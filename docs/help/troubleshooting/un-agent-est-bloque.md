...
2. Cliquez sur le bouton **Arrêter** en haut de la fiche agent. Une confirmation s'affiche.
3. Confirmez l'arrêt. L'agent passe en statut **ARRÊTÉ**. Relancez-le après avoir corrigé la cause (instructions trop vagues, outil manquant).
   ...
   > **Note :** il n'existe pas de bouton "Forcer l'arrêt" distinct — le bouton **Arrêter** envoie un signal d'arrêt normal. Si l'agent ne s'arrête pas, redémarrez l'application.
...
1. Cliquez sur **Arrêter** depuis sa fiche, puis relancez-le.
