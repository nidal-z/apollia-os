...
> **Référence technique :** [Ops-Exploitation-et-Debug](https://github.com/Apollia-OS/apollia-os/wiki/Ops-Exploitation-et-Debug) - interprétation détaillée des statuts FIRED/SKIPPED/ERROR, comportement `on_busy`, dépannage des déclenchements bloqués.
