...
> **Référence technique :** [Briques-Triggers](https://github.com/nidal-z/apollia-os/wiki/Briques-Triggers) — table complète des types, paramètres acceptés et expressions cron supportées.
