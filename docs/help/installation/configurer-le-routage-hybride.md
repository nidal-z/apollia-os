...
> **Référence technique :** [Briques-LLM-Backend](https://github.com/Apollia-OS/apollia-os/wiki/Briques-LLM-Backend) - paramètres de routing multi-backend, politique de fallback, calcul du coût par étape.
