...
> **Pour les profils techniques :** [Briques-Tool-Registry](https://github.com/Apollia-OS/apollia-os/wiki/Briques-Tool-Registry) (format `agent.toml`, outils natifs activables, structure d'un package).
