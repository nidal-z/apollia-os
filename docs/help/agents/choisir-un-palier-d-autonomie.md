...
> **Référence technique :** [Briques-ORIA-Engine](https://github.com/Apollia-OS/apollia-os/wiki/Briques-ORIA-Engine) - StepBudget, ResilienceLayer, comportement de chaque palier d'autonomie.
