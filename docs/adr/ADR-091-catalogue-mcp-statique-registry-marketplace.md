...
- **v0.3 (roadmap)** — **Registry remote dynamique** : repo public `nidal-z/apollia-mcp-registry` contenant `registry.json` au même schéma. Desktop sync au démarrage + cache local + SHA-256.
