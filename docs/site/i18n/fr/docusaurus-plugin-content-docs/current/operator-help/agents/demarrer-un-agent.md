...
1. Dans la sidebar, ouvrez **Mes assistants**. La colonne de gauche liste vos assistants sous **Mes assistants · N**.
   ![page Mes assistants - colonne de gauche avec les deux sections "Mes assistants" et "Mes packages" visibles](/img/operator-help/fr/agents-demarrer-un-agent-1.png)
...
4. Cliquez sur la ligne pour ouvrir le détail du package : vous y voyez la liste des agents qu'il contient, leurs rôles (*director* ou *worker*), et la liste des déclencheurs configurés (cron, webhook…).
   ![panneau de détail d'un package - sections Informations, Agents (avec rôles director/worker), Triggers](/img/operator-help/fr/agents-demarrer-un-agent-2.png)

![panneau de détail d'un package - sections Informations, Agents (avec rôles director/worker), Triggers (suite)](/img/operator-help/fr/agents-demarrer-un-agent-2bis.png)
...
> **Concept :** [Explication Apollia](/explanation) - comprendre la différence director/worker dans un package et leur cycle de vie.
