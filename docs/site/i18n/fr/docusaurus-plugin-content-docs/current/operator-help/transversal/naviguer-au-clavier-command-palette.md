...
1. Depuis n'importe quel écran, appuyez sur **Cmd+K** (macOS) ou **Ctrl+K** (Windows et Linux). La palette s'ouvre au centre de l'écran.
   ...
   ![command palette ouverte au centre de l'écran, champ de recherche en haut, suggestions groupées en dessous](/img/operator-help/fr/transversal-naviguer-au-clavier-command-palette-1.png)
...
![Page Parametres puis Raccourcis, barre de recherche en haut et raccourcis groupes par categorie](/img/operator-help/fr/transversal-naviguer-au-clavier-command-palette-2.png)
