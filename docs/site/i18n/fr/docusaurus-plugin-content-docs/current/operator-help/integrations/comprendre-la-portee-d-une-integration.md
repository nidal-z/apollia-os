...
![Fiche d'un agent, onglet Outils : la liste des outils requis et optionnels avec leurs badges d'approbation](/img/operator-help/fr/integration-comprendre-la-portee-d-une-integration-1.png)
