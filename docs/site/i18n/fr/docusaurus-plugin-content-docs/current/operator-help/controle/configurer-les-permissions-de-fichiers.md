...
3. Un message de confirmation apparaît brièvement. La carte disparaît immédiatement.
   ![carte d'autorisation avec bouton Révoquer visible, toast de confirmation "Règle bash révoquée"](/img/operator-help/fr/controle-configurer-les-permissions-de-fichiers-2.png)
...
![section Sessions actives, liste d'entrées avec badge orange Session et bouton Révoquer](/img/operator-help/fr/controle-configurer-les-permissions-de-fichiers-3.png)
...
3. Vérifiez le nombre de règles concernées affiché dans la boîte de dialogue, puis cliquez sur **Révoquer**.
   ![Dialogue Tout révoquer : le sélecteur de portée et le bouton de révocation](/img/operator-help/fr/controle-configurer-les-permissions-de-fichiers-1bis.png)
