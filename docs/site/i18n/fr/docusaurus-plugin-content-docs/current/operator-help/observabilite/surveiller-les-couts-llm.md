...
3. En haut, **quatre indicateurs clés** (KPI) résument la fenêtre sélectionnée :
   ...
   ![Onglet Couts LLM, selecteur de periode, quatre KPI, graphique en barres empilees et legende des backends](/img/operator-help/fr/observabilite-surveiller-les-couts-llm-1.png)
