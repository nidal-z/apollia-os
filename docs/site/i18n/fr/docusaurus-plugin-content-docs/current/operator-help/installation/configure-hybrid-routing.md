...
Pour surveiller l'escalade et le cumul de coût en temps réel, consultez la page d'observabilité. Voir [Surveiller les coûts LLM](../observabilite/monitor-ai-costs.md).
...
> **Référence technique :** [Référence Apollia](/reference) - paramètres de routing multi-backend, politique de fallback, calcul du coût par étape.
