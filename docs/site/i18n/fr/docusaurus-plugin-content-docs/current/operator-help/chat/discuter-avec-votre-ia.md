...
1. Dans la sidebar, cliquez sur **Chat**. La liste de vos conversations s'affiche à gauche, la zone de saisie au centre.
   ![page Chat, sidebar conversations à gauche, zone vide au centre avec champ de saisie en bas](/img/operator-help/fr/chat-discuter-avec-votre-ia-1.png)
...
5. Appuyez sur **Entrée** ou cliquez sur **Envoyer**. La réponse s'affiche en streaming, mot après mot.
   ![conversation avec un message utilisateur et une réponse IA en cours de streaming, formatage markdown rendu](/img/operator-help/fr/chat-discuter-avec-votre-ia-2.png)

![conversation avec un message utilisateur et une réponse IA en cours de streaming, formatage markdown rendu (suite)](/img/operator-help/fr/chat-discuter-avec-votre-ia-2bis.png)
