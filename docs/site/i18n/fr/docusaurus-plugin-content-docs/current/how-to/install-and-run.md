...
Sur Windows, exportez `LIBCLANG_PATH` dans le même shell avant de lancer
l'une de ces recettes (voir les prérequis Windows ci-dessus). Sur Linux, l'exécuteur de reconnaissance vocale a en plus besoin
