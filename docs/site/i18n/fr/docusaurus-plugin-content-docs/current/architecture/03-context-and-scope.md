...
flowchart TB
    ...
    subgraph external_systems [Systèmes externes]
        ...
        cloud["Fournisseurs de LLM cloud<br/>Anthropic / OpenAI / Vertex"]
...
| **Fournisseurs de LLM cloud** | Optionnel. Une exécution peut escalader vers un modèle de pointe avec la clé propre de l'utilisateur, le local restant la valeur par défaut. | Apollia appelle vers l'extérieur |
