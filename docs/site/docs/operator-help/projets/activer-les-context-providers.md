...
2. Scroll down to the **Context Providers** section. Three provider types are available.
   ![Context Providers section in the project panel, provider list with ON/OFF toggle](/img/operator-help/en/projets-activer-les-context-providers-1.png)
...
6. Switch each provider to ON or OFF depending on your needs.
   ![Git Status provider enabled (green toggle), Directory Tree provider disabled (grey toggle)](/img/operator-help/en/projets-activer-les-context-providers-2.png)
...
7. To see exactly what will be handed to the AI, click **Preview context** (Workspace Snapshot). A collapsible panel shows the content of each active provider.
   ![detailed preview of a context provider with git diff / file tree content](/img/operator-help/en/projets-activer-les-context-providers-3.png)
