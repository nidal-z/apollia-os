...
1. **From the Projects page**: click **Projects** in the sidebar, open the project, then click **+ New Chat** at the top right.
   ![project detail page, + New Chat button highlighted](/img/operator-help/en/projets-lier-un-projet-a-un-chat-1.png)
...
3. **From an existing chat**: open the chat, click the menu at the top (three dots), then click **Link to a project**.
   ![chat header, drop-down menu with the Link to a project option](/img/operator-help/en/projets-lier-un-projet-a-un-chat-2.png)
...
7. You can create several chats linked to the same project. Each keeps its own history but shares the same context.
   ![project page with the list of linked chats, each with its title and date](/img/operator-help/en/projets-lier-un-projet-a-un-chat-3.png)
