...
- **Settings → Permissions** answers *"what is this tool allowed to do right now"*: the persisted rules, their scope, their revocation. See [Manage tool permissions](manage-tool-permissions.md).
...
- The technical identifier shown under the panel title is the one you find in the **Tool** column of the [audit trail](../observabilite/read-the-audit-trail.md).
