...
3. At the top, **four key indicators** (KPI) summarise the selected window:
   ...
   ![LLM Costs tab, with the period selector, the four KPIs, the stacked bar chart and the backend legend](/img/operator-help/en/observabilite-surveiller-les-couts-llm-1.png)
