      ...
      <div className="container margin-vert--lg">
        ...
        <div className="row">
          <div className={clsx("col", {
            ...
            <input type="search" name="q" className={styles.searchQueryInput} aria-label={translate({
            id: "theme.SearchBar.label",
            message: "Search",
            description: "The ARIA label and placeholder for search button",
        })} onChange={handleSearchInputChange} value={searchQuery} autoComplete="off" autoFocus/>
          </div>
