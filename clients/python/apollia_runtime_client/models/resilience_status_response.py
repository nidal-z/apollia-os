...
if TYPE_CHECKING:
    from ..models.resilience_status_response_circuit_breakers_item import (
...
class ResilienceStatusResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for circuit_breakers_item_data in _circuit_breakers:
            circuit_breakers_item = ResilienceStatusResponseCircuitBreakersItem.from_dict(
                circuit_breakers_item_data
            )
