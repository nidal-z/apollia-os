...
from ...models.costs_response import CostsResponse
...
) -> ApiErrorBody | CostsResponse | None:
    if response.status_code == 200:
        response_200 = CostsResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | CostsResponse]:
    return Response(
