...
from ...models.authorize_tool_request import AuthorizeToolRequest
...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/api/v1/sessions/{id}/authorize".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        body (AuthorizeToolRequest): Request body for `POST /api/v1/sessions/:id/authorize`.
