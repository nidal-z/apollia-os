...
from ...models.todo_read_response import TodoReadResponse
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/sessions/{id}/todo".format(
...
) -> ApiErrorBody | TodoReadResponse | None:
    if response.status_code == 200:
        response_200 = TodoReadResponse.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | TodoReadResponse]:
    return Response(
