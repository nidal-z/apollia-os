...
from ...models.set_approval_body import SetApprovalBody
...
def _get_kwargs(
    name: str,
    *,
    body: SetApprovalBody,
) -> dict[str, Any]:
    headers: dict[str, Any] = {}

    _kwargs: dict[str, Any] = {
        "method": "patch",
        "url": "/api/v1/mcp/servers/{name}/approval".format(
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        name (str):
        body (SetApprovalBody): Request body for `PATCH /api/v1/mcp/servers/:name/approval`.
