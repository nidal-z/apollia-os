...
from ...models.stt_status_response import SttStatusResponse
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = SttStatusResponse.from_dict(response.json())
...
def sync(
    *,
    ...
    Returns:
        ApiErrorBody | SttStatusResponse
    """
