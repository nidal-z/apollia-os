...
from ...models.sidechain_row import SidechainRow
...
def _get_kwargs(
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": "/api/v1/tasks/{id}/sidechains".format(
...
) -> ApiErrorBody | list[SidechainRow] | None:
    if response.status_code == 200:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = SidechainRow.from_dict(response_200_item_data)
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[ApiErrorBody | list[SidechainRow]]:
    return Response(
...
def sync(
    ...
    *,
    ...
    Returns:
        ApiErrorBody | list[SidechainRow]
    """
