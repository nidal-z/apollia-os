...
fn runtime_event_to_sse(event: &RuntimeEvent, task_id: &str) -> Option<(SseTaskEvent, bool)> {
    match event {
        ...
        // ── Orchestrated plan events (STORY-087 / Sprint 10) ──────────────
...
mod tests {
    ...
    // ── Tests STORY-087 : orchestrated plan events ─────────────────────────

    #[test]
    fn test_ac1_plan_generated_converti() {
        // GIVEN RuntimeEvent::PlanGenerated pour task-001
        ...
        // WHEN converti en SSE
        let result = runtime_event_to_sse(&event, "task-001");

        // THEN event "plan_generated" non-terminal avec step_count
    ...
    fn test_ac2_step_started_converti() {
        // GIVEN RuntimeEvent::StepStarted pour task-001, step s1
        ...
        // THEN event "step_started" non-terminal avec num et total
    ...
    fn test_ac5_event_autre_task_filtre() {
        // GIVEN RuntimeEvent::StepStarted pour task-002 (autre task)
        let event = RuntimeEvent::StepStarted {
    ...
    fn test_ac4_plan_failed_est_terminal() {
        // GIVEN RuntimeEvent::PlanFailed pour task-001
        ...
        // THEN event "plan_failed" ET is_terminal=true (ferme le stream)
