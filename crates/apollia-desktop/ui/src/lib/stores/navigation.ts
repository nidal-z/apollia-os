...
export type Route = "dashboard" | "agents" | "tasks" | "chat" | "inbox" | "integrations" | "llm" | "automations" | "projects" | "memory" | "transcriptions" | "notifications" | "observability" | "settings" | "settings-permission-rules" | "design" | "design-motion" | "design-empty-states" | "design-dark-mode";
