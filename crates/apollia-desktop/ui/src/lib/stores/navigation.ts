...
export type Route = "dashboard" | "agents" | "tasks" | "chat" | "approvals" | "integrations" | "llm" | "triggers" | "pipelines" | "memory" | "transcriptions" | "notifications" | "observability" | "settings" | "onboarding";
