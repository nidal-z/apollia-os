...
export type Route = "dashboard" | "agents" | "tasks" | "chat" | "approvals" | "inbox" | "integrations" | "llm" | "triggers" | "automations" | "pipelines" | "projects" | "memory" | "transcriptions" | "notifications" | "observability" | "settings" | "settings-permission-rules" | "templates" | "onboarding" | "design" | "design-motion" | "design-empty-states" | "design-dark-mode";
