...
1. Dans la sidebar, cliquez sur **Settings**, puis sur l'onglet **LLM backends**.
   `[SCREENSHOT: page Settings, onglet LLM backends actif, liste vide ou avec backends existants]`
...
6. Saisissez le **nom du modèle** à utiliser (par exemple : `claude-3-5-sonnet-latest`, `gpt-4o`, ou `llama3.1:8b` pour Ollama).
