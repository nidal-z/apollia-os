...
1. Dans la sidebar, cliquez sur **Settings**, puis sur l'onglet **Model Hub**.
   `[SCREENSHOT: page Model Hub, liste des modèles disponibles avec colonnes Nom, Taille, Type, État]`

2. Filtrez la liste : **GGUF** pour les modèles d'IA conversationnelle, **Whisper** pour la dictée vocale. Vous pouvez aussi filtrer par taille ou par langue (Whisper).
